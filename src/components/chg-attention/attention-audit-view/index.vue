<template>
  <div>
    ...
    <Form ref="form2" :show-message="false" :model="formData" label-position="top">
      <FormItem label="关注原因描述" prop="gzyy" style="margin-left: 10px;" class="info_title">
        <Input type="textarea" show-word-limit :maxlength="1000" v-model="formData.gzyy" :rows="2" :autosize='{ minRows: 4, maxRows: 4 }' readonly></Input>
      </FormItem>
    </Form>
    <div v-show="true">
