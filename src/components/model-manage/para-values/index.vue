<template>
  <div>
    ...
    <Form ref="form2" :rules="rules" :show-message="false" :model="formData" label-position="top">
      <FormItem label="参数" prop="riskDis" style="margin-left: 10px;" class="info_title">
      ...
      <FormItem label="参数值" prop="ctlDis" style="margin-left: 10px;" class="info_title">
      ...
      <FormItem label="参数单位" prop="ctlDis" style="margin-left: 10px;" class="info_title">
        <Input type="textarea" show-word-limit :readonly="this.actionType === 'view'" :maxlength="200" v-model="formData.ctlDis" :rows="2" :autosize='{ minRows: 4, maxRows: 4 }'></Input>
      </FormItem>
      <FormItem label="修改原因" prop="ctlDis" style="margin-left: 10px;" class="info_title">
        <Input type="textarea" show-word-limit :readonly="this.actionType === 'view'" :maxlength="200" v-model="formData.ctlDis" :rows="2" :autosize='{ minRows: 4, maxRows: 4 }'></Input>
      </FormItem>
    </Form>
  </div>
