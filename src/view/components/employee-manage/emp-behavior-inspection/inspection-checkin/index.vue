<template>
  <div>
    ...
    <Modal v-model="showAddNonEmp" :loading="dataSaving" scrollable title="编外被排查人" width="700" ok-text="提交" :styles="{top: '10px'}"
      ...
      :footer-hide="this.actionType === 'view'"
      @on-ok="handleSaveChange">
      <AddNonEmp @saveCancel="handleSaveCancel" @saveSuccess="handleSaveSuccess" :saveNow_="saveNow" :rowData="{}" :selOption="{}" :actionType="this.actionType"></AddNonEmp>
    </Modal>
  </div>
</template>
